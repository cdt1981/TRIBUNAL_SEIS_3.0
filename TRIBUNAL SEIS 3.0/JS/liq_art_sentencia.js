...
function formula_LRT(coeficiente, incapacidad, ingBase) {
    ...
    transformar(ingBase) + " x " + incapacidad + " = " + transformar(formula_objetc.total) +".";
...
$(document).ready(function () {
    ...
    // $("#conozco").on("change", function(){

    //     if($(this).is(":checked")){
    //         $("#conRipte").attr("disabled", true);
    //         $("#sinRipte").attr("disabled", true); 
    //         $("#vibm").attr("disabled", true); 
    //         $("#quincenal").attr("disabled", true); 
    //     }
    ...
    //     document.getElementById("conRipte").toggleAttribute("disabled");
    //     document.getElementById("sinRipte").toggleAttribute("disabled");
    //     document.getElementById("vibm").toggleAttribute("disabled");
    //     document.getElementById("quincenal").toggleAttribute("disabled");
